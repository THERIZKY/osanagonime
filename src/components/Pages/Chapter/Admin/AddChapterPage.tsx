		...
		<div>
			...
			>
				...
				<label className=" flex flex-col gap-1 ">
					Judul Chapter
					<input type="text" className=" input input-bordered grow bg-transparent focus:outline-sky-500 focus:outline-2 " placeholder="Judul Chapter" required />
				</label>
				...
				<label htmlFor="" className=" flex flex-col gap-1">
					Manga
					<input type="text" list="manga" className="input input-bordered bg-transparent" placeholder="Manga" required />
					<datalist id="manga">
						<option>1</option>
						<option>1</option>
						<option>1</option>
				...
				<label className="flex flex-col gap-1 h-32" htmlFor="chapter">
					Image
					<textarea className="grow input bg-transparent h-full p-2 input-bordered resize-none" name="chapter" required />
				</label>
