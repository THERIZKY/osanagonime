				...
				<div className="md:pl-20 flex flex-col ">
					...
					<div className="flex flex-col justify-center items-center md:flex-row  w-full h-[45rem]">
						<div className="w-full md:w-1/2 flex  justify-center items-center">
							<Image src={"/img/animek.png"} width={650} height={650} alt="home-image" />
						</div>
						<div className="w-full md:w-1/2flex flex-col justify-center gap-10">
							<div className="flex justify-center md:justify-start">
								<Image src={"/img/osanagoTrans.png"} width={300} height={300} alt="logo" />
							</div>
							<form action="" className="flex gap-5">
								<input type="text" className="w-[600px] h-[60px] rounded-full pl-5" placeholder="Search Anime" />
