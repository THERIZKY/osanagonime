    ...
    <div className="">
      <div className="btm-nav bg-gray-800 ">
        <div className=" order-3">
          <Link
            href={""}
            className="w-10 h-10 text-blue-500 bg-slate-800 rounded-full -top-1 border-2 border-blue-500 p-4  relative flex items-center justify-center"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 448 512"
              className="w-7 h-7 absolute top-1/2 -translate-y-1/2"
              fill="currentColor"
            >
